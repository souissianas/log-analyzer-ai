...
const translations = {
  fr: {
    ...
    profileTagline: 'Analyste Systèmes & Spécialiste Log AI',
    profileAboutHeader: 'Sur moi',
    profileAboutText: 'Analyste passionné par le traitement automatique de logs et le diagnostic système assisté par IA. Expert en détection d\'anomalies, architectures cloud et sécurité des données.',
    profileDetailsHeader: 'Des détails',
    profileNameLabel: 'Nom :',
    profileAgeLabel: 'Rôle :',
    profileLocationLabel: 'Emplacement :',
    profileLocationDefault: 'Tunis, Tunisie',
    profileMemberSince: 'Membre depuis :',
    profileEditBtn: '✏️ Modifier le profil',
  ...
  en: {
    ...
    profileTagline: 'Systems Analyst & AI Log Specialist',
    profileAboutHeader: 'About me',
    profileAboutText: 'Analyst passionate about automated log processing and AI-assisted system diagnostics. Expert in anomaly detection, cloud architectures, and data security.',
    profileDetailsHeader: 'Details',
    profileNameLabel: 'Name:',
    profileAgeLabel: 'Role:',
    profileLocationLabel: 'Location:',
    profileLocationDefault: 'Tunis, Tunisia',
